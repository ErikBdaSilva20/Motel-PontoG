    ...
    <>
      ...
      <HeroSection id="inicio">
        <Container>
          <HeroContent>
            ...
            <HeroSubtitle>
              Onde conforto, privacidade e sofisticação se encontram para criar
      ...
      <Section id="suites">
        <Container>
          ...
          <SectionSubtitle>
            Ambientes sofisticados e confortáveis para sua experiência perfeita
          </SectionSubtitle>
          ...
          <SuitesGrid>
            <SuiteCard>
              ...
              <SuiteContent>
                ...
                <SuiteDescription>
                  Ambiente aconchegante com decoração elegante, ideal para
                  momentos especiais a dois.
                </SuiteDescription>
                <SuiteFeatures>
            ...
            <SuiteCard>
              ...
              <SuiteContent>
                ...
                <SuiteDescription>
                  Espaço amplo com acabamento premium e todas as comodidades
                  para seu conforto.
                </SuiteDescription>
                <SuiteFeatures>
            ...
            <SuiteCard>
              ...
              <SuiteContent>
                ...
                <SuiteDescription>
                  Nossa suíte mais exclusiva, com design sofisticado e
      ...
      <Section id="sobre">
        <Container>
          ...
          <AboutContent>
            <AboutText>
              O Ponto G Motel é referência em hospitalidade e conforto na
              região. Com mais de 15 anos de experiência, oferecemos ambientes
              sofisticados e discretos para casais que buscam privacidade e
              momentos especiais.
            </AboutText>
            <AboutText>
              Nossas instalações são projetadas com atenção aos mínimos
              detalhes, garantindo uma experiência única e memorável. Cada suíte
              é cuidadosamente decorada e equipada com as melhores comodidades
              do mercado.
            </AboutText>
            <AboutText>
              Valorizamos a privacidade dos nossos hóspedes e mantemos os mais
              altos padrões de higiene e segurança. Nossa equipe está sempre
              pronta para proporcionar um atendimento excepcional e discreto.
            </AboutText>
          </AboutContent>
        </Container>
      </Section>
        ...
        <Container>
          ...
          <InfoGrid>
            <InfoCard>
              ...
              <InfoText>
                Garagens individuais com acesso direto à suíte, garantindo total
            ...
            <InfoCard>
              ...
              <InfoText>
                Sistema de monitoramento nas áreas comuns e equipe de segurança
                presente durante todo o período.
              </InfoText>
            </InfoCard>
            ...
            <InfoCard>
              ...
              <InfoText>
                Check-in e check-out discretos, sem necessidade de contato
                direto com a recepção.
              </InfoText>
            </InfoCard>
            ...
            <InfoCard>
              ...
              <InfoText>
                Seus dados pessoais são protegidos e nunca compartilhados com
                terceiros.
              </InfoText>
            </InfoCard>
          </InfoGrid>
      ...
      <Section id="conforto">
        <Container>
          ...
          <SectionSubtitle>
            Padrões elevados de limpeza e manutenção
          </SectionSubtitle>
          ...
          <InfoGrid>
            <InfoCard>
              ...
              <InfoText>
                Higienização completa entre cada hospedagem com produtos de alta
                qualidade e protocolos rigorosos.
              </InfoText>
            </InfoCard>
            ...
            <InfoCard>
              ...
              <InfoText>
                Lençóis e toalhas 100% algodão, trocados e higienizados após
                cada uso.
              </InfoText>
            </InfoCard>
            ...
            <InfoCard>
              ...
              <InfoText>
                Ar condicionado em todas as suítes com manutenção preventiva
                regular e filtros limpos.
              </InfoText>
            </InfoCard>
            ...
            <InfoCard>
              ...
              <InfoText>
                Sistema de aquecimento de água de alta eficiência para seu
                conforto total.
              </InfoText>
            </InfoCard>
          </InfoGrid>
      ...
      <TestimonialsSection>
        <Container>
          ...
          <SectionSubtitle>
            Experiências reais de quem já nos visitou
          </SectionSubtitle>

          <InfoGrid>
            <TestimonialCard>
              <TestimonialText>
                "Lugar incrível! Suíte impecável, atendimento discreto e tudo
                muito limpo. Com certeza voltaremos mais vezes."
              </TestimonialText>
            ...
            <TestimonialCard>
              <TestimonialText>
                "A privacidade e o conforto são incomparáveis. As suítes são
                lindas e muito bem equipadas. Recomendo!"
              </TestimonialText>
            ...
            <TestimonialCard>
              <TestimonialText>
                "Melhor motel da região! Ambiente sofisticado, limpo e
                aconchegante. O pacote romântico é perfeito!"
              </TestimonialText>
      ...
      <Section id="blog">
        <Container>
          ...
          <SectionSubtitle>
            Dicas e novidades para tornar sua experiência ainda melhor
          </SectionSubtitle>
          ...
          <BlogGrid>
            <BlogCard>
              ...
              <BlogContent>
                ...
                <BlogExcerpt>
                  Descubra qual suíte combina mais com o momento que você deseja
                  criar. Conheça as características de cada ambiente...
                </BlogExcerpt>
            ...
            <BlogCard>
              ...
              <BlogContent>
                ...
                <BlogExcerpt>
                  ...
                  Desde a escolha da suíte até os detalhes que fazem a
                  diferença...
                </BlogExcerpt>
                <Button variant="outline" size="small">
                  Ler Mais
            ...
            <BlogCard>
              ...
              <BlogContent>
                ...
                <BlogExcerpt>
                  Conheça as melhorias e novos recursos que implementamos nas
                  nossas suítes premium para sua experiência ser ainda melhor...
                </BlogExcerpt>
                <Button variant="outline" size="small">
                  Ler Mais
                </Button>
